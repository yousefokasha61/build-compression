...
[![shipthatcode — Build Your Own Compression Algorithm](https://api.shipthatcode.com/cert/646beb0b093aa5fdf329adaa17a2ffa3.svg)](https://shipthatcode.com/courses/build-compression)
...
Courses improve over time — exercises get added, tests get fixed. If the [course page](https://shipthatcode.com/courses/build-compression) says your starter is out of date: download a fresh zip, **delete this repo's `tests/` folder entirely**, copy in the fresh `tests/` and `.shipthatcode.json`, and keep your own code exactly as it is. (Don't merge test folders — lesson numbering can shift between versions.) Lessons you've already completed stay completed either way.
